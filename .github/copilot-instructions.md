...
`consensus-engine` — Quality-scored consensus system for multi-agent conversations — structured tag extraction, SQLite persistence, confidence-gated synthesis.
